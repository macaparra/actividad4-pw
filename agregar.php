        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-4">
                <div class="card">
                  ...
                  <form action="registrarMedicion.php<?php echo (array_key_exists("id_pozo",$_GET)?"?pozo_id=".$_GET['id_pozo']:"");?>" class="p-4" method="POST">
                    <div class="mb-3">
                        <label  class="form-label">Medicion:</label>
                        <input type="number" name="medicion" class="form-control" autofocus require>
                    </div>
                    <div class="d-grid">
                        <?php if(array_key_exists("id_pozo",$_GET)){ ?><input type="hidden" name="pozo_id" value="<?php echo $_GET['id_pozo'] ?>"><?php } ?>
